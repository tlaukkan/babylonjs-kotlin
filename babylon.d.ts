...
declare module BABYLON {
    ...
    function serialize(sourceName?: string): (target: any, propertyKey: any) => void;
    function serializeAsTexture(sourceName?: string): (target: any, propertyKey: any) => void;
    function serializeAsColor3(sourceName?: string): (target: any, propertyKey: any) => void;
    function serializeAsFresnelParameters(sourceName?: string): (target: any, propertyKey: any) => void;
    function serializeAsVector2(sourceName?: string): (target: any, propertyKey: any) => void;
    function serializeAsVector3(sourceName?: string): (target: any, propertyKey: any) => void;
    function serializeAsMeshReference(sourceName?: string): (target: any, propertyKey: any) => void;
    function serializeAsColorCurves(sourceName?: string): (target: any, propertyKey: any) => void;
    function serializeAsColor4(sourceName?: string): (target: any, propertyKey: any) => void;
    function serializeAsImageProcessingConfiguration(sourceName?: string): (target: any, propertyKey: any) => void;
