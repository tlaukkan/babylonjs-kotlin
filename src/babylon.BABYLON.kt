...
external open class SceneLoader {
    companion object {
        ...
        fun ImportMesh(meshesNames: Any, rootUrl: String, sceneFilename: String, scene: Scene, onsuccess: ((meshes: Array<AbstractMesh>, particleSystems: Array<ParticleSystem>, skeletons: Array<Skeleton>) -> Unit)? = definedExternally /* null */, progressCallBack: (() -> Unit)? = definedExternally /* null */, onerror: ((scene: Scene, message: String, exception: Any? /*= null*/) -> Unit)? = definedExternally /* null */): Unit = definedExternally
